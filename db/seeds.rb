...
# Fred F. Marshall Correspondence Collection
# Source: CORE Scholar, Wright State University Special Collections (MS-53)
...
puts "Created #{Item.count} items from the Fred F. Marshall Correspondence collection!"
puts "Source: CORE Scholar, Wright State University Special Collections (MS-53)"
